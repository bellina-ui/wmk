...
var g_user_on_key func(
	key hal.Keyboard_Key,
	action hal.Button_Action,
	alt,
	ctrl,
	shift bool)
...
func glfw_on_key(
	...
	if g_user_on_key != nil {
		g_user_on_key(_key, _action, mods&glfw.ModAlt != 0, mods&glfw.ModControl != 0, mods&glfw.ModShift != 0)
	}
}
